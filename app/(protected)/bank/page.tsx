...
export default function BankPage() {
  ...
  return (
    /* Conteneur utilisant toute la hauteur - ajusté pour tenir compte du layout parent */
    <div className="fixed top-[128px] left-0 right-0 bottom-0 overflow-hidden -mx-4 sm:-mx-6 lg:-mx-8 -my-6">
      <motion.div 
