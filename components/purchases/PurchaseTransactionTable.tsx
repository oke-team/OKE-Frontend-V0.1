...
import PurchaseMobileView from './PurchaseMobileView';
import PurchaseBalanceWidgets from './PurchaseBalanceWidgets';
...
export default function PurchaseTransactionTable({
  ...
  React.useEffect(() => {
    ...
    (window as any).togglePurchaseFilters = () => setShowFilters(!showFilters);
    return () => {
      delete (window as any).togglePurchaseFilters;
    };
  }, [showFilters]);
