...
import PurchaseBalanceWidgets, { BankAccount, BalanceSummary } from './PurchaseBalanceWidgets';
...
export default function PurchaseMobileView({
  transactions,
  ...
  React.useEffect(() => {
    if (typeof window !== 'undefined') {
      (window as any).togglePurchaseFiltersMobile = onToggleFilters;
      return () => {
        delete (window as any).togglePurchaseFiltersMobile;
      };
    }
  }, [onToggleFilters]);
