...
import { cabinetLogos, Banque } from '@/lib/mock-data/cabinet-dashboard-data';
...
interface CabinetBalanceWidgetsProps {
  accounts: CabinetAccount[];
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2">
        ...
        {/* Logo de la banque */}
        <img 
          src={cabinetLogos[account.bankCode]} 
...
export default function CabinetBalanceWidgets({
  accounts,
  summary,
  showBalances,
  onToggleVisibility,
