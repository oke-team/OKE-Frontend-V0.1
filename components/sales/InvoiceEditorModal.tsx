...
export default function InvoiceEditorModal({ 
  ...
  // Fonction optimisée pour mettre à jour les données
            ...
            <div className="flex-shrink-0 px-8 py-6 flex items-center justify-between border-b border-gray-100/50" style={{
              ...
              <div className="flex items-center gap-2">
                ...
                <GlassButton 
                  ...
                  className="bg-gradient-to-r from-[#FAA016] to-[#FAA016]/90 text-white shadow-md hover:shadow-lg transition-all duration-200"
                >
                ...
                <GlassButton 
                  onClick={handleEmail} 
                  className="bg-gradient-to-r from-[#4C34CE] to-[#4C34CE]/90 text-white shadow-md hover:shadow-lg transition-all duration-200"
                >
                ...
                <div className="relative">
                  <GlassButton
                    ...
                    className="bg-white/60 text-gray-700 hover:bg-white/80 border border-gray-200/50 shadow-sm px-3"
                  >
                      ...
                      >
                        <div className="py-2">
                          <button
                            ...
                            className="w-full px-4 py-2.5 text-left text-sm text-gray-700 hover:bg-white/50 flex items-center gap-3 transition-colors disabled:opacity-50"
                          >
                            <RefreshCw className={`w-4 h-4 ${isProcessing ? 'animate-spin' : ''}`} />
                            {isProcessing ? 'Relance en cours...' : 'Relancer le client'}
                          </button>
                          <button
                            onClick={() => { handleManageSubscriptions(); setShowAdvancedMenu(false); }}
                            className="w-full px-4 py-2.5 text-left text-sm text-gray-700 hover:bg-white/50 flex items-center gap-3 transition-colors"
                          >
                ...
                <GlassButton 
                  onClick={handleSave} 
                  className="bg-gradient-to-r from-emerald-500 to-emerald-600 text-white shadow-md hover:shadow-lg transition-all duration-200"
                >
                ...
                <button
                  onClick={onClose}
                  className="p-2.5 text-gray-400 hover:text-gray-600 transition-colors rounded-xl hover:bg-gray-100/50 ml-2"
                >
                  <X className="w-5 h-5" />
                </button>
              </div>
