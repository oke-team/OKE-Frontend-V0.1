...
interface InvoiceEditorModal2Props {
  isOpen: boolean;
  onClose: () => void;
}
...
export default function InvoiceEditorModal2({ 
  isOpen, 
  onClose
}: InvoiceEditorModal2Props) {
  ...
  return (
    <AnimatePresence>
      {isOpen && (
        ...
        >
          {/* Modal Container avec Sidebar */}
          <motion.div
            initial={{ scale: 0.95, opacity: 0 }}
            animate={{ scale: 1, opacity: 1 }}
            exit={{ scale: 0.95, opacity: 0 }}
            transition={{ duration: 0.3 }}
            className="relative m-8 h-[calc(100vh-4rem)] flex"
            style={{
          ...
          >
            {/* SIDEBAR ACTIONS - PANNEAU LATÉRAL DROIT */}
            <motion.div 
              initial={{ x: 100, opacity: 0 }}
              animate={{ x: 0, opacity: 1 }}
              transition={{ delay: 0.2, duration: 0.3 }}
              className="flex-shrink-0 w-80 border-l border-gray-100/50 flex flex-col"
              style={{
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-6">
                {/* ÉDITION */}
                <div>
                  <h3 className="text-xs font-medium text-gray-400 uppercase tracking-wider mb-3">Édition</h3>
                  <div className="space-y-2">
                    <GlassButton 
                      onClick={handlePreview} 
                      className="w-full bg-white/60 text-gray-700 hover:bg-white/80 border border-gray-200/50 shadow-sm justify-start"
                    >
                ...
                {/* EXPORT & IMPRESSION */}
                <div>
                  <h3 className="text-xs font-medium text-gray-400 uppercase tracking-wider mb-3">Export & Impression</h3>
                  <div className="space-y-2">
                    <GlassButton 
                      onClick={handleDownload} 
                      className="w-full bg-gradient-to-r from-[#FAA016] to-[#FAA016]/90 text-white shadow-md hover:shadow-lg transition-all duration-200 justify-start"
                    >
                ...
                {/* ENVOI & PARTAGE */}
                <div>
                  <h3 className="text-xs font-medium text-gray-400 uppercase tracking-wider mb-3">Envoi & Partage</h3>
                  <div className="space-y-2">
                    <GlassButton 
                      onClick={handleEmail} 
                      className="w-full bg-gradient-to-r from-[#4C34CE] to-[#4C34CE]/90 text-white shadow-md hover:shadow-lg transition-all duration-200 justify-start"
                    >
                    ...
                    <GlassButton 
                      ...
                      className="w-full bg-white/60 text-gray-700 hover:bg-white/80 border border-gray-200/50 shadow-sm justify-start disabled:opacity-50"
                    >
                      <RefreshCw className={`w-4 h-4 mr-3 ${isProcessing ? 'animate-spin' : ''}`} />
                      {isProcessing ? 'Relance...' : 'Relancer le client'}
                      <ChevronRight className="w-4 h-4 ml-auto" />
                    </GlassButton>
                  </div>
                </div>
                ...
                {/* GESTION AVANCÉE */}
                <div>
                  <h3 className="text-xs font-medium text-gray-400 uppercase tracking-wider mb-3">Gestion avancée</h3>
                  <div className="space-y-2">
                    <GlassButton 
              ...
              {/* Footer Sidebar avec Sauvegarder */}
              <div className="p-4 border-t border-gray-100/50">
                <GlassButton 
                  onClick={handleSave} 
                  className="w-full bg-gradient-to-r from-emerald-500 to-emerald-600 text-white shadow-md hover:shadow-lg transition-all duration-200 justify-center py-3"
                >
            ...
            <div className="flex-1 flex flex-col">
              {/* Header Principal Minimaliste */}
              <div className="flex-shrink-0 px-8 py-6 border-b border-gray-100/50">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-0.5">
                      ...
                      <span className="text-sm text-gray-500">Dernière modification il y a 2 minutes</span>
                    </div>
                  </div>
                </div>
              </div>
